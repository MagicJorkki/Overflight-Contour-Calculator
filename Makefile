...
#		begin				: 2026-07-30
#		git sha				: $Format:%H$
#		copyright			: (C) 2026 by Leevi Miettinen / Finavia Oyj
...
SOURCES = \
	__init__.py \
	overflight_contour_calculator.py overflight_contour_calculator_dialog.py

PLUGINNAME = overflight_contour_calculator

PY_FILES = \
	__init__.py \
	overflight_contour_calculator.py overflight_contour_calculator_dialog.py

UI_FILES = overflight_contour_calculator_dialog_base.ui
...
QGISDIR=C:\Users\MACC\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
